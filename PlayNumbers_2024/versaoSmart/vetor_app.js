import { adicionar_novos_valores, editar_valor_posicao, elevar_valores_de_vetor, embaralhar_vetor, iniciar_vetor_numerico, mostrar_media_valores, mostrar_menorEmaior_e_posicoes, mostrar_quantidade_vetor, mostrar_somatorio_dos_valores, mostrar_valores, mostrar_valores_negativos_quantidade, mostrar_valores_positivos_quantidade, multiplicar_valores_de_vetor, ordenar_vetor, remover_itens_valor_exato, remover_porPosicao, resetar_vetor, salvar_arquivo, substituir_numeros_negativos_por_aleatorio } from './vetor_funcionalidades.js'
import { obter_numero, obter_numero_max, obter_numero_min_max, print } from './utils.js'
