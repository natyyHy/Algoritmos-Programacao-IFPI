import { print, iniciar_vetor_numerico , mostrar_todos_valores , resetar_vetor , mostrar_quantidade_vetor , mostrar_menorEmaior_e_posicoes ,
    mostrar_somatorio_dos_valores , mostrar_media_valores , mostrar_valores_positivos_quantidade , mostrar_valores_negativos_quantidade, 
    multiplicar_valores_de_vetor , elevar_valores_de_vetor,substituir_numeros_negativos_por_aleatorio,ordenar_vetor,embaralhar_vetor,
    adicionar_novos_valores,remover_itens_valor_exato,remover_porPosicao,editar_valor_posicao,
    salvar_arquivo} from './vetor_funcionalidades.js'

import { obter_numero, obter_numero_max, obter_numero_min_max } from './utils.js'
    ...
    while(escolhaUsuario !== 16){
        ...
        if(escolhaUsuario !== 16){
            ...
            if (escolhaUsuario === 1) {
                ...
                mostrar_todos_valores(vetor_numerico)
                ...
                mostrar_valores_negativos_quantidade(vetor_numerico)
                ...
                if(escolhaUser === 1){
                    ...
                    const numero = obter_numero('DIGITE A FRACAO: ')
